...
This newfound perspective of attackers being able to find monitoring blindspots to cover their tracks to persist in undetected malicious behavior is what showed me that simply deploying a SIEM or endpoint agent does not automatically produce complete security. This especially became apparent when my Wazuh did not monitor all the alerts that should have been triggered. I had to reproduce parts of the activity such as with the sensitive file so I can better understand the gap that failed to provide visibility. Simply installing security tools is not enough to ensure your systems and networks are secured, it requires tools to be properly configured, validated, maintained, and continuously improved. The threat lanscaoe is an ongoing contestable environment with both the offensive and defensive sides vying for either data extraction or data preservation.  

I had many setbacks such as misconfigured network settings, correcting domain configurations, troubleshooting DNS and gateway problems, encountering packages that were not updated, lack of permissions, agent communication problems, and having to expand storage and memory capacities for certain software such as Wazuh. Having these experiences taught me to slow down and put in the time and effort to go through error messages carefully and understanding the reason behind a solution instead of just blindly repeating commands. But in many cases, each time I succeeded in a troubleshooting scenario, it revealed to me the dependencies and issues associated with the problem. This process gave me a much deeper appreciation for the disicpline and determination troubleshooting required in real technical environments. I find these setbacks to be some of the most valuable parts of the experience because they required me to hone in habits that are ideal in a cybersecurity career such as curiosity, patience, documentation, and the willingness to keep investigating. During the investigation process, I was motivated to learn more about networking, permissions, operating system commands and packages, and interaction between all the different components to gain a stronger grasp on what best to do for certain setbacks. 

There is still so much I want to learn. I want to continue improving the environment by creating and tuning additional SIEM rules, improving incident-response workflows, and incorporating additional endpoint and network telemetry. This homelab is not meant to be a finished product, but rather a starting foundation that I can continue expanding on as I learn more offensive and defensive measures. 

To conclude, this project confirmed why I continue to immerse myself in tech. I enjoy understanding how it all works independently and together and investigating why a certain component fails or finding out why the entire structure is not properly running. What I enjoyed most was seeing the homelab gradually becoming a complete working environment rather than a collection of isolated virtual machines. This overall experience strengthened my appreciation for the complexity of information technology and reminded me that this is a field where we never stop learning. There will always be new technologies, vulnerabilities, attack techniques and defensive strategies which I find to be exciting. The more I learn, the more aware I become of much content there actually is to understand and this is exactly what keeps me motivated, the novelty and holisitc demand is what continues to intrigue me about this field! 
